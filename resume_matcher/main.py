...
import re       # let me search ,match and extract text patterns
import spacy    # NLP
...
def process_file():
    ...
    extracted_text={}
    def get_email_adresses(string):
        r=re.compile(r'[\w\.-]+@[\w\.-]+')
        return r.findall(string)
    

    email_list=get_email_adresses(text)
    ...
    def extract_skills(resume_text):
        ...
        skills = ["machine learning","deep learning","nlp","natural language processing","mysql","sql","django","computer vision","tensorflow", "opencv","mongodb","react","bootstrap","mern","express","mobile app","node",
                "web app","mongo","sql","web","artificial intelligence","ai","flask","robotics","data structures","python","c++","matlab","css","html","github","php"]
...
#Your API returns JSON like:
#{
#  "email": "john@example.com",
  #"phone": ["1234567890"],
#  "name": ["John Doe"],
#  "skills": ["Python", "Machine Learning"],
  #"qualification": ["BSc", ["MSc", "2020"]],
  #institutes": ["Stanford University"],
#  "experience": ["Tech Solutions Pvt. Ltd."],
  #"path": "resumes/CV.pdf"
#}
